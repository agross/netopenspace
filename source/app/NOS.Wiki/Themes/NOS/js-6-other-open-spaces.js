$(document).ready(function()
{
	...
	$.getJSON('http://netopenspace.de/all-net-open-spaces.ashx?jsoncallback=?',
			function (json) {
				...
				{
					var list = buildList(local.PastEvents,
					...
					list.insertAfter("#HeaderDiv");
				}
				
				if (remotes)
				{
					var list = buildList(remotes,
